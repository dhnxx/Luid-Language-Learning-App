...
public final class ActivitySentenceFragment2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivitySentenceFragment2Binding(@NonNull ConstraintLayout rootView,
      @NonNull TextView answerLabel, @NonNull Button clearButton,
      @NonNull ConstraintLayout constraintLayout4, @NonNull FlexboxLayout flexboxLayout,
      @NonNull Button nextButton, @NonNull ProgressBar progressBar, @NonNull TextView question,
      @NonNull ImageView questionImage, @NonNull Button submitButton, @NonNull TextView timetxt,
  ...
  @NonNull
  public static ActivitySentenceFragment2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySentenceFragment2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_sentence_fragment2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySentenceFragment2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySentenceFragment2Binding((ConstraintLayout) rootView, answerLabel,
          clearButton, constraintLayout4, flexboxLayout, nextButton, progressBar, question,
          questionImage, submitButton, timetxt, toolbar);
    }
