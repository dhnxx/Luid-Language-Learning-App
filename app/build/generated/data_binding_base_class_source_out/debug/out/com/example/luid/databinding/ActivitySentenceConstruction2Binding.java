...
public final class ActivitySentenceConstruction2Binding implements ViewBinding {
  @NonNull
  ...
  private ActivitySentenceConstruction2Binding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static ActivitySentenceConstruction2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySentenceConstruction2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_sentence_construction2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySentenceConstruction2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySentenceConstruction2Binding((ScrollView) rootView, answerLabel,
