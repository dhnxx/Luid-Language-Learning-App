        ...
        if(selectedLevel == 2 && selectedPhase == 1){
            ...
            storyList.add(
                StoryClass(
                    "Elena",
                    false,
                    "Isang kahon po mg sansrival.",
                    "Metung pung kahun ning sansribal.",
                    R.drawable.elena
                )
            )
        ...
        if(selectedLevel == 3 && selectedPhase == 2){
            ...
            storyList.add(
                StoryClass(
                    ...
                    "Karakal palang taung makipamyesta keti.",
                    R.drawable.kian
                )
            )
        ...
        if(selectedLevel == 3 && selectedPhase == 3){
            ...
            storyList.add(
                StoryClass(
                    "Kian",
                    true,
                    "Punta tayo sa ibang lugar, tito.",
                    "place holder",
                    R.drawable.kian
                )
            )
            ...
            storyList.add(
                StoryClass(
                    "Elena",
                    false,
                    "Grabi talaga ang dugong Pilipino. Kayang tapatan kahit anong problema.",
                    "place holder",
                    R.drawable.elena
                )
            )
            ...
            storyList.add(
                StoryClass(
                    "Noel",
                    false,
                    "Ang susunod nating pupuntahan ay ang Museo ning Angeles.",
                    "place holder",
                    R.drawable.noel
                )
            )
            ...
            storyList.add(
                StoryClass(
                    "Kian",
                    true,
                    "Malalaman po ba namin ang pamumuhay ng mga tao noon?",
                    "place holder",
                    R.drawable.kian
                )
            )
            ...
            storyList.add(
                StoryClass(
                    "Noek",
                    false,
                    "Syempre naman, kasama na diyan ang sining.",
                    "place holder",
                    R.drawable.noel
                )
            )
